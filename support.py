...
def set_up():       #makes the setting window
    ...
    #pygame.draw.rect(WINDOW, (0, 0, 255), label)
    #font_path = "F:/FONTS_/PressStart2P-Regular.ttf"
    #font = pygame.font.SysFont(font_path, 69, True)
    ...
    #pygame.draw.rect(WINDOW, (0, 0, 255), easy_rect)
    ...
    #pygame.draw.rect(WINDOW, (0, 0, 255), mid_rect)
    ...
    #pygame.draw.rect(WINDOW, (0, 0, 255), hard_rect)
...
def end_game():
    ...
    text = end_font.render("GAME ENDED", 1, BLACK)
